...
class TruncatedBaseNetwork(BaseNetwork):
    ...
    def __init__(self, config, name="truncated_base_network", **kwargs):
        ...
        self._scope_endpoint = "{}/{}/{}".format(self.module_name, config.architecture, self._endpoint)
        ...
        if self._use_tail and not self._freeze_tail:
            if self._architecture == "resnet_v1_101":
                ...
                try:
                    ...
                    raise ValueError('"block4" not present in the trainable vars retrieved ' "from base network.")
    ...
    def _get_endpoint(self, endpoints):
        ...
        raise ValueError('"{}" is an invalid value of endpoint for this ' "architecture.".format(self._scope_endpoint))
