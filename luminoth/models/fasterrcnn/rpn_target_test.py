...
class RPNTargetTest(tf.test.TestCase):
    ...
    def testBaseCase(self):
        ...
        labels, bbox_targets, max_overlaps = self._run_rpn_target(all_anchors, self.gt_boxes, self.config)
    ...
    def testBorderOutsiders(self):
        ...
        labels, bbox_targets, max_overlaps = self._run_rpn_target(all_anchors, self.gt_boxes, config)
    ...
    def testWithMultipleGTBoxes(self):
        ...
        labels, bbox_targets, max_overlaps = self._run_rpn_target(all_anchors, gt_boxes, config)
    ...
    def testWithManyGTBoxes(self):
        ...
        gt_boxes = np.array([[2, 2, 8, 8], [12, 12, 18, 18], [22, 22, 28, 28], [32, 32, 38, 38]])
        labels, bbox_targets, max_overlaps = self._run_rpn_target(all_anchors, gt_boxes, config)
