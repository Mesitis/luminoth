...
class BlockTriangularMatrix(base.AbstractModule):
    ...
    def __init__(
        ...
        self._upper = upper
        self._num_blocks = sum(self._content_blocks(r) for r in xrange(self._block_rows))
    ...
    def output_shape(self):
        ...
        return (
            self._block_shape[0] * self._block_rows,
    ...
    def _build(self, vector):
        ...
        for r in xrange(self._block_rows):
            ...
            assert left_zero_blocks + content_blocks + right_zero_blocks == self._block_rows
