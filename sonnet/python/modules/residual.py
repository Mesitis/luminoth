...
class SkipConnectionCore(rnn_core.RNNCore):
    ...
    def _build(self, inputs, prev_state):
        ...
        outputs = nest.map_structure(lambda inp, out: tf.concat((inp, out), -1), inputs, outputs)
    ...
    def output_size(self):
        ...
        return tf.TensorShape(leading_dims + (self._base_core.output_size[-1] + final_input_dim,))
